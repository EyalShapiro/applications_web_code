...
export const BackgroundHeader=()=>{
  return (<div style={{overflow: 'hidden',margin:'100px'}}>
  <svg preserveAspectRatio="none" viewBox="0 0 800 200" xmlns="http://www.w3.org/2000/svg" style={{fill: '#a9d8a6', width: '100%', height: '185px', transform: 'rotate(180deg)'}}>
...
ReactDOM.createRoot(document.getElementById('root')).render(
  <React.StrictMode>
    <BackgroundHeader><h1  className="Header" >Pokémon Info Search</h1></BackgroundHeader>
